...
//        	   .or(() -> findIn2ndLevelCache(customerId))
    ...
    private static Optional<String> findInCache(final String customerId)
    {
        ...
        return Optional.empty(); // Optional.of("PETER"); //
    }

    private static Optional<String> findIn2ndLevelCache(final String customerId)
    {
        System.out.println("findIn2ndLevelCache");
